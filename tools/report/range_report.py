	...
	for r in intervals:
		if r.begin < len( font ) and r.end < len( font ):
			...
			try: 
				...
				print( "interval", r, "not representable in",
					font.fontname, file=stderr )
				exit( 1 )
	return num
...
<style type="text/css">
	...
	th, td { padding: 0; border: thin black solid; }
