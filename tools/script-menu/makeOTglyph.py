...
__copyright__ = "Copyright 2015, Stevan White"
__date__ = "$Date:: 2015-04-09 12:44:41 +0200#$"
...
Sets the OpenType glyph class of the selected range of slots to 'baseglyph'
...
try:
	...
	for g in glyphs:
		print( "setting", g.glyphname, 'glyph class to', 'baseglyph' )
		g.glyphclass = 'baseglyph'
except ValueError, e:
